...
const scriptURL = "https://script.google.com/macros/s/AKfycby7Me-bY_5g5r_HbnIfkwdFW6z5uMoJeQCNGg8zDDdnRT4unydpiDOfwrqUTw164N4r/exec";
...
function autofillEmail() {
    // بررسی اینکه آیا ایمیل قبلاً ذخیره شده است یا خیر
    const storedEmail = localStorage.getItem("userEmail");

    // اگر ایمیل ذخیره شده باشد، آن را در فیلد ایمیل قرار می‌دهیم
    if (storedEmail) {
